...
export function HeroSection() {
  return (
    <header className="relative overflow-hidden px-4 pb-16 pt-24 md:px-8 md:pb-24 md:pt-32 lg:pt-40">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-10 lg:flex-row lg:gap-16">
        ...
        <div className="z-10 w-full lg:w-1/2">
          <span className="mb-4 inline-block rounded-full bg-accent/20 px-4 py-1 text-xs font-bold uppercase tracking-widest text-accent md:mb-6">
            Qui Sommes-Nous
          </span>
          <h1 className="mb-6 font-headline text-4xl font-black leading-tight tracking-tighter text-foreground md:mb-8 md:text-5xl lg:text-6xl xl:text-7xl lg:leading-[1.1]">
        ...
        <div className="relative w-full lg:w-1/2">
          <div className="absolute -right-10 -top-10 -z-10 size-64 rounded-full bg-primary/5" />
